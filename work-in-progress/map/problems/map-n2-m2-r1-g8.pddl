(define (problem map-n2-m2-r1-g8)
	(:domain map)
	(:objects
		square-x0-y0 square-x0-y1 square-x1-y0 square-x1-y1 - location
		robot-1 - robot
		gps-1 gps-2 gps-3 gps-4 gps-5 gps-6 gps-7 gps-8 - gps
	)
	(:init
