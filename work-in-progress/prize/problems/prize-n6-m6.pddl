(define (problem prize-n6-m6)
	(:domain prize)
	(:objects
		square-x0-y0 square-x0-y1 square-x0-y2 square-x0-y3 square-x0-y4 square-x0-y5 square-x1-y0 square-x1-y1 square-x1-y2 square-x1-y3 square-x1-y4 square-x1-y5 square-x2-y0 square-x2-y1 square-x2-y2 square-x2-y3 square-x2-y4 square-x2-y5 square-x3-y0 square-x3-y1 square-x3-y2 square-x3-y3 square-x3-y4 square-x3-y5 square-x4-y0 square-x4-y1 square-x4-y2 square-x4-y3 square-x4-y4 square-x4-y5 square-x5-y0 square-x5-y1 square-x5-y2 square-x5-y3 square-x5-y4 square-x5-y5
	)
	(:init
		(at square-x0-y0)
