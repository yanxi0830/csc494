(define (problem prize-n4-m4)
	(:domain prize)
	(:objects
		square-x0-y0 square-x0-y1 square-x0-y2 square-x0-y3 square-x1-y0 square-x1-y1 square-x1-y2 square-x1-y3 square-x2-y0 square-x2-y1 square-x2-y2 square-x2-y3 square-x3-y0 square-x3-y1 square-x3-y2 square-x3-y3
	)
	(:init
		(at square-x0-y0)
