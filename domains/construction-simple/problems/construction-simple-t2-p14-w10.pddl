(define (problem construction-simple-t2-p14-w10)
	...
	(:objects
		...
		part-1 part-2 part-3 part-4 part-5 part-6 part-7 part-8 part-9 part-10 part-11 part-12 part-13 part-14 - part
