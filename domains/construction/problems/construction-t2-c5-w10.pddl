(define (problem construction-t2-c5-w10)
	(:domain construction)
	(:objects
		worker-1 worker-2 worker-3 worker-4 worker-5 worker-6 worker-7 worker-8 worker-9 worker-10 - worker
		truck-1 truck-2 - truck
		wood-part-1 wood-part-2 wood-part-3 wood-part-4 wood-part-5 - part
		glass-part-1 glass-part-2 glass-part-3 glass-part-4 glass-part-5 - part
		clay-part-1 clay-part-2 clay-part-3 clay-part-4 clay-part-5 - part
		composite-1 composite-2 composite-3 composite-4 composite-5 - composite
