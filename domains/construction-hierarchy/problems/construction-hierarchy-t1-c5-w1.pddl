(define (problem construction-hierarchy-t1-c5-w1)
	(:domain construction-hierarchy)
	(:objects
		worker-1 - worker
		truck-1 - truck
		wood-part-1 wood-part-2 wood-part-3 wood-part-4 wood-part-5 - wood-part
		glass-part-1 glass-part-2 glass-part-3 glass-part-4 glass-part-5 - glass-part
		clay-part-1 clay-part-2 clay-part-3 clay-part-4 clay-part-5 - clay-part
