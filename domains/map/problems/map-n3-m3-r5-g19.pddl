(define (problem map-n3-m3-r5-g19)
	(:domain map)
	(:objects
		...
		gps-1 gps-2 gps-3 gps-4 gps-5 gps-6 gps-7 gps-8 gps-9 gps-10 gps-11 gps-12 gps-13 gps-14 gps-15 gps-16 gps-17 gps-18 gps-19 - gps
	)
	(:init
		...
		(at gps-17 square-x2-y2)
		(visited gps-17 square-x2-y2)
		(at gps-18 square-x2-y2)
		(visited gps-18 square-x2-y2)
		(at gps-19 square-x2-y2)
		(visited gps-19 square-x2-y2)
	)
	(:goal (and
		...
		(visited gps-16 square-x2-y2)
		(visited gps-17 square-x0-y0)
		(visited gps-17 square-x0-y1)
		(visited gps-17 square-x0-y2)
		(visited gps-17 square-x1-y0)
		(visited gps-17 square-x1-y1)
		(visited gps-17 square-x1-y2)
		(visited gps-17 square-x2-y0)
		(visited gps-17 square-x2-y1)
		(visited gps-17 square-x2-y2)
		(visited gps-18 square-x0-y0)
		(visited gps-18 square-x0-y1)
		(visited gps-18 square-x0-y2)
		(visited gps-18 square-x1-y0)
		(visited gps-18 square-x1-y1)
		(visited gps-18 square-x1-y2)
		(visited gps-18 square-x2-y0)
		(visited gps-18 square-x2-y1)
		(visited gps-18 square-x2-y2)
		(visited gps-19 square-x0-y0)
		(visited gps-19 square-x0-y1)
		(visited gps-19 square-x0-y2)
		(visited gps-19 square-x1-y0)
		(visited gps-19 square-x1-y1)
		(visited gps-19 square-x1-y2)
		(visited gps-19 square-x2-y0)
		(visited gps-19 square-x2-y1)
		(visited gps-19 square-x2-y2)
		)
	)
)
