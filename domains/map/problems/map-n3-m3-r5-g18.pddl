(define (problem map-n3-m3-r5-g18)
	(:domain map)
	(:objects
		...
		gps-1 gps-2 gps-3 gps-4 gps-5 gps-6 gps-7 gps-8 gps-9 gps-10 gps-11 gps-12 gps-13 gps-14 gps-15 gps-16 gps-17 gps-18 - gps
	)
	(:init
